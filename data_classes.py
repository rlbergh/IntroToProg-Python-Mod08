# ------------------------------------------------------------------------------------------------- #
# Title: data_classes
# # Description: Data classes of a program to collect Employee rating data
...
class Employee(Person):
    ...
    def review_date(self, value: str):
        try:
            review_date_obj = date.fromisoformat(value)
        # Check to see if date is in correct format
        except ValueError:
            raise ValueError(f"Incorrect date format, should be YYYY-MM-DD")
